...
export interface IViewerHost extends IReportError {
    createPanel<T>(component: preact.ComponentChild, binder: IStateBinder<T>, key: string, settings: Partial<PanelSettings>): PanelHandle;
...
export interface IPluginModule<TEvent extends IViewerEvent, TAction> {
    ...
    openDocument(location: DocumentMoniker): Promise<IDocument | null>;
